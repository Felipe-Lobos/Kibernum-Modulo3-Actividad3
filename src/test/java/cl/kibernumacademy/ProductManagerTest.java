...
public class ProductManagerTest {
    ...
    void shouldAddProductWhenDataIsValid(String name, String description, int price) {
        ...
        // Comprobar que el nombre del nuevo producto sea el mismo que venia en los
        // parametros
    ...
    void updateProductTest(String name, String description, int price) {
        ...
        // Se valida que los parametros name y description no sean null, y price sea un
        // valor mayor a 0
        assumeTrue(name != null && description != null && price > 0);
        ...
        assumingThat(productUpdated != null, () -> {
            ...
            // Comprobar que el name del producto actualizado sea el mismo que el del
            // parametro
    ...
    void deleteProductTest() {
        ...
        // Validamos de que el producto haya sido eliminado
        assumingThat(deleted, () -> {
